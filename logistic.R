...
GM_Monthly_return_1<-(cum_performance_1[length(cum_performance_1)])^(1/length(cum_performance_1))-1
...
GM_Monthly_return_3<-(cum_performance_1[length(cum_performance_3)])^(1/length(cum_performance_3))-1
...
df<-t(df)
names(df)[1] = "Period Return"
names(df)[2] = "GM Daily Return"
